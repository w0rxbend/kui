...
| [ADR-057](docs/adr/ADR-057-design-captures-stay-outside-the-repository.md) | The design captures stay outside the repository: `.gitignore` stands, the committed artefact is the reading and not the pixels, every document that said *committed* is corrected, and definition-of-done item 1's subject becomes the `M01`…`M23` index rather than a working-tree directory | Accepted | 2026-09-12 |
