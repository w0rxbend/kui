...
**Counts as of the 2026-09-06 wave-4 recount** (189 capability rows): 68 `COMPLETE`, 18 `REVIEW`,
9 `IMPLEMENTING`, 1 `SERVICE DONE, NO UI`, 2 `PARTIAL`, 80 `RESEARCHING` (not started),
