...
5. Every verification pass writes `verification/W<NN>-<packet>.md` before its packet freezes, so that
   a finding is a row a later packet can close rather than a paragraph nobody reads. Wave 7's closer
